...
namespace asobotcar {
    ...
    export function left(forward_percent: number = 50) {
        ...
        // 左右のモーター速度を計算
        let leftSpeed = 90 - 90 * (forward_percent) / 100;  // 左モーター
        let rightSpeed = 90 - 90 * (forward_percent) / 100; // 右モーター
    ...
    export function turn_left(forward_percent: number = 50, turn_percent: number = 50) {
        ...
        // 左右のモーター速度を計算
        let leftSpeed = 90 - 90 * (forward_percent) / 100;  // 左モーター
        let rightSpeed = 90 + 90 * (1 - turn_percent / 100) * (forward_percent) / 100; // 右モーター
    ...
    export function turn_right(forward_percent: number = 50, turn_percent: number = 50) {
        ...
        // 左右のモーター速度を計算
        let leftSpeed = 90 - 90 * (1 - turn_percent / 100) * (forward_percent) / 100;  // 左モーター
        let rightSpeed = 90 + 90 * (forward_percent) / 100; // 右モーター
    ...
    export function back(back_percent: number = 50) {
        ...
        // 左右のモーター速度を計算
        let leftSpeed = 90 + 90 * (back_percent + Adjust_percent) / 100;  // 左モーター
        let rightSpeed = 90 - 90 * (back_percent - Adjust_percent) / 100; // 右モーター
